...
def train_and_score():
    ...
    # --- FIX: Use robust, hard-coded feature lists ---
    numeric_features = [
    ...
    text_features = ['Top 5 Investors'] # Assuming 'Description' is not in the new file
    ...
    for col in numeric_features:
        if col in df_train.columns:
            ...
            df_train[col] = np.nan # Add missing feature columns
